...
bool RGBWWLed::fadeHSV(const RequestHSVCT& color, const RampTimeOrSpeed& ramp, int stay, int direction, bool requeue,
                       const String& name) {
...
bool RGBWWLed::fadeHSV(const RequestHSVCT& color, const RampTimeOrSpeed& ramp, int stay, int direction,
...
bool RGBWWLed::fadeHSV(const RequestHSVCT& colorFrom, const RequestHSVCT& color, const RampTimeOrSpeed& ramp, int stay,
    ...
    result &=
        pushAnimTransition(colorFrom.h, color.h, ramp, stay, direction, queuePolicy, CtrlChannel::Hue, requeue, name);
    result &=
        pushAnimTransition(colorFrom.s, color.s, ramp, stay, direction, queuePolicy, CtrlChannel::Sat, requeue, name);
    result &=
        pushAnimTransition(colorFrom.v, color.v, ramp, stay, direction, queuePolicy, CtrlChannel::Val, requeue, name);
    result &= pushAnimTransition(colorFrom.ct, color.ct, ramp, stay, direction, queuePolicy, CtrlChannel::ColorTemp,
                                 requeue, name);
...
bool RGBWWLed::fadeRAW(const RequestChannelOutput& output_from, const RequestChannelOutput& output,
    ...
    result &=
        pushAnimTransition(output_from.g, output.g, ramp, stay, -1, queuePolicy, CtrlChannel::Green, requeue, name);
    result &=
        pushAnimTransition(output_from.b, output.b, ramp, stay, -1, queuePolicy, CtrlChannel::Blue, requeue, name);
    result &= pushAnimTransition(output_from.ww, output.ww, ramp, stay, -1, queuePolicy, CtrlChannel::WarmWhite,
                                 requeue, name);
    result &= pushAnimTransition(output_from.cw, output.cw, ramp, stay, -1, queuePolicy, CtrlChannel::ColdWhite,
                                 requeue, name);
